...
- Absence of explicit bond reconstruction at defects (e.g., 5-8-5 reconstruction at graphene divacancies, dimer reconstruction at Si surfaces, Jahn-Teller-like distortions). DFT relaxation introduces these from a sensible unrelaxed starting geometry; the script doesn't need to pre-apply them.
